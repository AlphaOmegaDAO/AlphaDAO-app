...
function OhmMenu() {
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="OX" aria-describedby={id}>
        <SvgIcon component={InfoIcon} color="primary" />
        <Typography>OX</Typography>
      </Button>
              ...
              <Paper className="ohm-menu" elevation={1}>
                <Box component="div" className="buy-tokens">
                  ...
                  >
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
                      Get OX-BUSD LP <SvgIcon component={ArrowUpIcon} htmlColor="#A3A3A3" />
                      </Typography>
                    </Button>
                  </Link>
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("OX", PID_ADDRESS)}>
                        <TokenIcon size={32} symbol="OX"/>
                        <Typography variant="body1">Alpha OX</Typography>
                      </Button>
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sOX", SPID_ADDRESS)}>
