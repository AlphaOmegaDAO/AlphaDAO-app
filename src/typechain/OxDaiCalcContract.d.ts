...
interface OxDaiCalcContractInterface extends ethers.utils.Interface {
  functions: {
    "OX()": FunctionFragment;
...
export class OxDaiCalcContract extends BaseContract {
  ...
  interface: OxDaiCalcContractInterface;
