...
import { Stake, ChooseBond, Bond, Wrap, TreasuryDashboard, Claim, Presale, ComingSoon } from './views';
...
function App() {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on app.alphadao.financial!"));
    }
  }, []);
