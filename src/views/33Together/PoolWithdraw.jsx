      ...
      {!address ? (
        ...
        <Box className="withdrawal-container">
          <Box display="flex" alignItems="center" flexDirection={`${isMobileScreen ? "column" : "row"}`}>
              ...
              <OutlinedInput
                ...
                startAdornment={
                  <InputAdornment position="start">
                    <div className="logo-holder">{soxImg}</div>
                  </InputAdornment>
                }
                labelWidth={0}
                endAdornment={
            ...
            >
              {exitFee > 0
                ? txnButtonText(pendingTransactions, "pool_withdraw", "Withdraw Early & pay " + exitFee + " sOX")
                : txnButtonText(pendingTransactions, "pool_withdraw", "Withdraw sOX")}
              {/* Withdraw sOX */}
            </Button>
          </Box>
          {newOdds > 0 && quantity > 0 && (
            <Box padding={1}>
              <Typography color="error" variant="body2">
                Withdrawing {quantity} sOX reduces your odds of winning to 1 in {newOdds}&nbsp;
              </Typography>
            </Box>
          )}
          {exitFee > 0 && (
