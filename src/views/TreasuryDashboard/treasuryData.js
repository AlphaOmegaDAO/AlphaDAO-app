...
export const tooltipInfoMessages = {
  tvl:
    'Total Value Deposited, is the dollar amount of all OX staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.',
  ...
  holder: 'Holders, represents the total number of Ohmies (xOX holders)',
  staked: 'OX Staked, is the ratio of xOX to OX (staked vs unstaked)',
  apy:
  ...
  runway: 'Runway, is the number of days xOX emissions can be sustained at a given rate. Lower APY = longer runway'
};
