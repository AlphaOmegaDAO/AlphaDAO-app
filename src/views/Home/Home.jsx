...
function Home() {
  ...
  return <div className="home_gd">
    ...
    <div className="boodyBox fxColumn">
      ...
      The Educational Treasury Reserve Protocol for Paideia.</div>
      <div className="fxBetween">
        <a href="/stake" className="btnBox_1">Enter App</a>
        <a href="https://docs.alphadao.financial" className="btnBox_2 a" target="_blank">Documentation</a>
      </div>
    ...
    <div className="bottomBor a">
      <a href="https://twitter.com/AlphaOmegaDAO" target="_blank" className="bottomImgs a2">
<img src={img1_1} alt="" className="bottomImgs2" /></a>
      <a href="https://github.com/AlphaOmegaDAO" target="_blank" className="bottomImgs a2">
<img src={img1_2} alt="" className="bottomImgs2" /></a>
      <a href="https://discord.com/invite/kMSg8AGmnD" target="_blank" className="bottomImgs a2">
<img src={DiscordImg} alt="" className="bottomImgs2" /></a>
