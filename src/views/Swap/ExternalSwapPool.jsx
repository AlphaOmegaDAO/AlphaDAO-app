...
export default function ExternalSwapPool() {
    ...
    <Zoom in={true}>
      <Paper className={`ohm-card secondary ${isSmallScreen && "mobile"}`}>
        ...
        <div className="card-content">
          {!isSmallScreen ? (
            <TableContainer className="swap-table">
              <Table>
                <TableHead>
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="center">
                      <Button
                        ...
                        target="_blank"
                        className="swap-lp-button"
                      >
                        <Typography variant="body1">Swap in Crucible</Typography>
