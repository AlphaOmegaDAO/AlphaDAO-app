  ...
  async function onBond() {
    if (quantity === "") {
      ...
      const shouldProceed = window.confirm(
        `You are trying to purchase Bond for the address ${shorten(recipientAddress)}, please ensure the wallet address has connected to Alpha & Omega DAO to view the Bond information after purchase succeeds.`,
      );
      if (shouldProceed) {
        await dispatch(
          bondAsset({
